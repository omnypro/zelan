...
export class TokenManager implements ITokenManager {
  ...
  constructor() {
    ...
    this.tokenStorePath = path.join(app.getPath('userData'), 'auth-tokens.enc')
    ...
    // Initialize logger
    this.logger = getLoggingService().createLogger('TokenManager')
  }
  ...
  private async readTokens(): Promise<Record<string, AuthToken>> {
    try {
      ...
      this.logger.error('Error reading tokens', {
