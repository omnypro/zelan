...
impl WebSocketTestEnvironment {
    ...
    pub async fn publish_event(&self, source: &str, event_type: &str, payload: serde_json::Value) -> Result<usize> {
    ...
    pub async fn wait_for_client_messages(&self, client_id: &str, count: usize, timeout_ms: u64) -> Result<bool> {
