...
pub trait HttpClient: Send + Sync {
    ...
    async fn post(&self, url: &str, headers: HashMap<String, String>, body: String) -> Result<SimpleHttpResponse>;
}
...
pub mod mock {
    ...
    impl MockHttpClient {
        ...
        pub fn mock_response(&mut self, url: impl Into<String>, status: u16, body: impl Into<String>) {
    ...
    impl HttpClient for MockHttpClient {
        async fn get(&self, url: &str, _headers: HashMap<String, String>) -> Result<SimpleHttpResponse> {
            // Record the request
        ...
        async fn post(&self, url: &str, _headers: HashMap<String, String>, _body: String) -> Result<SimpleHttpResponse> {
            // Record the request
