...
export class AdapterSettingsStore {
  ...
  /**
   * Get singleton instance of AdapterSettingsStore
   */
  public static getInstance(): AdapterSettingsStore {
    if (!AdapterSettingsStore.instance) {
      AdapterSettingsStore.instance = new AdapterSettingsStore();
    }
    return AdapterSettingsStore.instance;
  }
