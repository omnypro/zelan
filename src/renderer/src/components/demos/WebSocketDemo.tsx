      ...
      {!isTrpcAvailable() ? (
        <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mb-4">
          ...
          <p className="text-sm mt-1">
            The WebSocket server control functionality is not available. This may be because the tRPC
            client is still initializing or the WebSocket endpoints are not properly registered.
          </p>
          <button
            onClick={fetchStatus}
              ...
              {status.running && (
                <div className="mt-6 border-t pt-4">
                  ...
                  <div className="bg-gray-100 p-3 rounded font-mono text-sm">
                    <p>WebSocket URL: <span className="text-blue-600">ws://localhost:{status.port}</span></p>
                  </div>
